...
# Determine which metadata file to use (prefer best_growth_model_metadata.json if available)
metadata_files = [
    local_growth_dir / "best_growth_model_metadata.json",
    local_growth_dir / "growth_model_metadata.json",
    METADATA_PATH
]
...
if not metadata_file or not metadata_file.exists():
    raise FileNotFoundError(f"Metadata file not found. Tried: {[str(mf) for mf in metadata_files]}")
